...
<html lang="en">
  <head>
    ...
    <title>Leivina Gourmet Seblak</title>
  </head>
  <body>
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="user.php"><strong>Leivina</strong> Gourmet Seblak</a>
  ...
  <!-- Menu -->    
      <div class="container">
        <div class="judul text-center mt-5">
          <h3 class="font-weight-bold">Leivina Gourmet Seblak</h3>
          <h5>Gang Maknyus No. 7, Kecamatan Leivina Seblakville, Kota Nikmat, Indonesia
        ...
        <div class="row mb-5 mt-5 ">
          <div class="col-md-6 d-flex justify-content-end">
            <div class="card bg-dark text-white border-light">
              <img src="images/background/seblak.jpg" class="card-img" alt="Lihat Daftar Menu">
          ...
          <div class="col-md-6 d-flex justify-content-start">
            <div class="card bg-dark text-white border-light">
              <img src="images/background/seblak.jpg" class="card-img" alt="Lihat Pesanan">
              <div class="card-img-overlay mt-5 text-center">
  ...
  <!-- Awal Footer -->
      ...
      <div class="container">
        <div class="row footer-body">
          <div class="col-md-6">
          <div class="copyright">
            <strong>Seblak Mantul</strong> <i class="far fa-copyright"></i> 2020 -  Designed by Leivina</p>
          </div>
          </div>
